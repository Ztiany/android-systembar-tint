...
public class AHBottomNavigationBehavior<V extends View> extends VerticalScrollingBehavior<V> {
	...
	private boolean hidden = false;//隐藏状态

	private ViewPropertyAnimatorCompat translationAnimator;//动画
	...
	private int mSnackbarHeight = -1;//默认SnackBar高度

	private boolean fabBottomMarginInitialized = false;//fab是否初始化了margin
